...
$sql = "Update Vaccination_status 
        set `Second_Dose` = '$sdose' , `Vaccine_Type` = '$vaccine' , `Vaccinated_By` = '$docname' , `second_date` = '$date'
...
<html lang="en">
  ...
  <strong>VACCINATION SUCCESS</strong> Second dose completed. Now you can download your certificate. 
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
   ...
   echo'
    <div class="alert alert-success alert-dismissible fade show" role="alert">
  <strong>SUCCESS</strong> Check benificiary valid date for second dose.
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
  </div>';
    } 
...
$sql = " SELECT * from vaccination_status where Refer_ID='$referenceid' ";
...
<td><?php echo $rest['First_Dose'] ?></td>
<td><?php echo $rest['first_date'] ?></td>
<td><?php echo $rest['vaccine_type'] ?></td>
</tr>
        ...
        <h1></br></h1>
<form class="row g-3" action="/COVID_VACCINATION/Second_Dose.php" method="post" >
<h1 class = 'text-center' style="color:blue;font-size:30px;">Select the information for first dose</h1>
<h1> </br> </h1>

<h1  style="color:red;font-size:30px;">Second Dose : </h1>
<div class="form-check">
  <input class="form-check-input" type="radio" value="Success" id="sdose" name="sdose">
  <label class="form-check-label" for="sdose">
    Success
  </label>
</div>
